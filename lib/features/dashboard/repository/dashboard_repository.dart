  ...
  Future<DashboardMetrics> getMetrics() async {
    if (ApiConstants.useMockData) {
      ...
      return const DashboardMetrics(
        ...
        slaPerformance: [
          SLADepartmentPerformance(
              department: 'Forest Guard (Survey)', percentage: 82.0, slaDays: 7),
          SLADepartmentPerformance(
              department: 'Range Officer (Verify)', percentage: 91.0, slaDays: 3),
          SLADepartmentPerformance(
              department: 'DFO (Valuation)', percentage: 78.0, slaDays: 5),
          SLADepartmentPerformance(
              department: 'UKPCB (Compliance)', percentage: 85.0, slaDays: 4),
          SLADepartmentPerformance(
              department: 'District Magistrate', percentage: 88.0, slaDays: 3),
          SLADepartmentPerformance(
              department: 'Treasury (Payment)', percentage: 74.0, slaDays: 7),
        ],
        recentActivities: [
          RecentActivity(
    ...
    try {
      final response = await dio.get(ApiEndpoints.dashboardMetrics);
